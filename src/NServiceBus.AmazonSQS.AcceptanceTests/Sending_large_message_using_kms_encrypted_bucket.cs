namespace NServiceBus.AcceptanceTests
{
    ...
    public class Sending_large_message_using_kms_encrypted_bucket : NServiceBusAcceptanceTest
    {
        ...
        public async Task Should_receive_message()
        {
            ...
            Assert.DoesNotThrowAsync(async () => await s3Client.GetObjectAsync(BucketName, $"{SqsTransportConfigurationExtensions.S3Prefix}/{context.MessageId}"));
        }
        ...
        public class Endpoint : EndpointConfigurationBuilder
        {
            public Endpoint()
            {
                EndpointSetup<DefaultServer>(c =>
                {
                    ...
                    BucketName = $"{SqsTransportConfigurationExtensions.S3BucketName}.kms";

                    transportConfig.S3BucketForLargeMessages(BucketName, SqsTransportConfigurationExtensions.S3Prefix);
                });
            }
