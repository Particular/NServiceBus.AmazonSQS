namespace NServiceBus.AcceptanceTests.DelayedDelivery
{
    ...
    public class When_receiver_delays_received_message_that_requires_multiple_cycles : NServiceBusAcceptanceTest
    {
        [Test]
        public async Task Should_deliver_message()
        {
            ...
            var context = await Scenario.Define<Context>()
                ...
                .WithEndpoint<Receiver>(b => b.CustomConfig(c => c.ConfigureSqsTransport().UnrestrictedDurationDelayedDelivery(QueueDelayTime, regenerateMessageDeduplicationId: true)))
                .Done(c => c.Received)
                .Run();
