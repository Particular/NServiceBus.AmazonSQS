namespace NServiceBus.Transports.SQS
{
    ...
    {
        public DelayedMessagesPump(TransportConfiguration configuration, IAmazonSQS sqsClient, QueueUrlCache queueCache)
        {
        ...
        public async Task Initialize(string inputQueue, string inputQueueUrl)
        {
            ...
            delayedDeliveryQueueUrl = await queueCache.GetQueueUrl(QueueNameHelper.GetSqsQueueName(delayedDeliveryQueueName, configuration))
        ...
        readonly QueueUrlCache queueCache;
