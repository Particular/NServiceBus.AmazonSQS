namespace NServiceBus.AmazonSQS.Tests
{
    ...
    [TestFixture]
    public class SqsTransportMessageTests
    {
        ...
        public void Defaults_TimeToBeReceived_to_TimeSpan_MaxTime_when_DiscardIfNotReceivedBefore_is_not_provided()
        {
            ...
            var transportMessage = new SqsTransportMessage(outgoingMessage, deliveryConstrants);
        ...
        {
            var transportMessage = new SqsTransportMessage();
        ...
        public void Adds_TimeToBeReceived_Header_when_property_value_is_provided()
        {
            ...
            Assert.IsTrue(transportMessage.Headers.ContainsKey(SqsTransportHeaders.TimeToBeReceived), "TimeToBeReceived header is missing");
            Assert.AreEqual(expectedTtbr.ToString(), transportMessage.Headers[SqsTransportHeaders.TimeToBeReceived], "TimeToBeReceived header does not match expected value.");
        }
        ...
        public void Does_not_add_TimeToBeReceived_Header_when_property_is_set_to_null()
        {
            ...
            Assert.IsFalse(transportMessage.Headers.ContainsKey(SqsTransportHeaders.TimeToBeReceived), "TimeToBeReceived header was populated");
        }
        ...
        public void Populates_ReplyToAddress_when_header_is_present()
        {
            ...
            var transportMessage = new SqsTransportMessage(outgoingMessage, new List<DeliveryConstraint>());
