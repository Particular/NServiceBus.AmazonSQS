namespace NServiceBus.AmazonSQS.Tests
{
    ...
    public class InputQueuePumpTests
    {
        ...
        public void SetUp()
        {
            ...
            pump = new InputQueuePump(transportConfiguration, mockS3Client, mockSqsClient, new QueueUrlCache(mockSqsClient));
        }
        ...
        public async Task Start_loops_until_canceled()
        {
            ...
            Assert.IsTrue(mockSqsClient.ReceiveMessagesRequestsSent.All(r => r.MessageAttributeNames.SequenceEqual(new List<string> {Headers.MessageId})), "MessageAttributeNames did not match");
