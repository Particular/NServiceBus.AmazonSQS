namespace NServiceBus.Transport.SQS
{
    ...
    class DelayedMessagesPump
    {
        ...
        async Task ConsumeDelayedMessagesLoop(ReceiveMessageRequest request, CancellationToken token = default)
        {
        ...
        internal async Task ConsumeDelayedMessages(ReceiveMessageRequest request, CancellationToken token = default)
        {
            ...
            await BatchDispatchPreparedMessages(preparedMessages, token).ConfigureAwait(false);
        }
