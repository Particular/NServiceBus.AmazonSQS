...
public class When_transport_message_serialized_with_simplejson : NServiceBusAcceptanceTest
{
    ...
    const string PayloadSerializedWithSimpleJson = """
                                                   {
                                                     "Headers": {
                                                       "NServiceBus.MessageId": "6637ac9d-2af5-4900-8f23-af9c00eb9918",
                                                       "NServiceBus.MessageIntent": "Send",
                                                       "NServiceBus.ConversationId": "16e18ac2-92ca-495a-9fcd-af9c00eb9922",
                                                       "NServiceBus.CorrelationId": "6637ac9d-2af5-4900-8f23-af9c00eb9918",
                                                       "NServiceBus.ReplyToAddress": "ATBFYA7YY5MEIE8MFHSGENCWSendingInCompatibilityMode-Sender",
                                                       "NServiceBus.OriginatingMachine": "somecomputer",
                                                       "NServiceBus.OriginatingEndpoint": "TransportMessageSerializedWithSimplejson.Sender",
                                                       "$.diagnostics.originating.hostid": "4de9545ac822a29fb4bfb9a70d0cea92",
                                                       "NServiceBus.ContentType": "application/json",
                                                       "NServiceBus.EnclosedMessageTypes": "NServiceBus.AcceptanceTests.When_transport_message_serialized_with_simplejson+Message, NServiceBus.Transport.SQS.AcceptanceTests",
                                                       "NServiceBus.Version": "8.0.3",
                                                       "NServiceBus.TimeSent": "2023-02-01 14:17:47:234185 Z"
                                                     },
                                                     "Body": "e30=",
                                                     "S3BodyKey": null
                                                   }
